...
RUN apk --no-cache --update add zip tzdata php81 php81-fpm php81-pdo_mysql php81-mysqli php81-json php81-iconv php81-openssl php81-curl php81-ctype \
    ...
    php81-mbstring php81-gd php81-zip libwebp-dev libzip-dev libjpeg-turbo-dev supervisor curl git openssh-client mysql-client
